			...
			t && function (e, t) {
				...
				o ? o.addFettis(w) : (e.appendChild(A), o = function (e, t, n) {
					...
					"6+aJ": function (e, t, i) {
						...
						var R = i("VU/8")(T, P, !1, function (e) {
								i("d8tw")
							}, "data-v-87308f38", null).exports,
						O = {
							initialViewIndex: 0,
							inline: !1,
							button: !0,
						...
						X = "viewer-in",
						U = "viewer-transition",
						W = F.PointerEvent ? "pointerdown" : "touchstart mousedown",
						j = F.PointerEvent ? "pointermove" : "touchmove mousemove",
						Y = F.PointerEvent ? "pointerup pointercancel" : "touchend touchcancel mouseup",
						V = ["zoom-in", "zoom-out", "one-to-one", "reset", "prev", "play", "next", "rotate-left", "rotate-right", "flip-horizontal", "flip-vertical"],
						...
						function K(e) {
							return "object" === (void 0 === e ? "undefined" : q(e)) && null !== e
						}
						...
						me = function () {
							...
							if (L) {
								...
								F.addEventListener("test", i, n),
								F.removeEventListener("test", i, n)
							}
							return e
						}
						();
						...
						var Ae = F.navigator && /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(F.navigator.userAgent);
						function ye(e, t) {
						...
						xe = {
							bind: function () {
								...
								ge(e, W, this.onPointerDown = this.pointerdown.bind(this)),
								ge(t.ownerDocument, j, this.onPointerMove = this.pointermove.bind(this)),
							...
							unbind: function () {
								...
								fe(e, W, this.onPointerDown),
								fe(t.ownerDocument, j, this.onPointerMove),
						...
						Ne = i("aCzh"),
						De = i.n(Ne),
						He = (s.a, Oe.a, Fe.default, n.a.debounce(function (e) {
							...
							mounted: function () {
								...
								o.a.appRoot.$on("redpack", function (e) {
									"RedPacketCollarMessage" === e.chatType ? (t.isCollaring = !1, t.redpackInfo.details.push({
											...
											createDatetime: Object(Le.a)(new Date, "YYYY-MM-DD HH:mm:ss")
						...
						var Ue = i("VU/8")(He, Xe, !1, function (e) {
								i("RlMw")
							}, "data-v-ca02f1bc", null).exports,
						We = (B.swiper, B.swiperSlide, Boolean, String, {
							components: {
								swiper: B.swiper,
								swiperSlide: B.swiperSlide
							},
						...
						var Ye = i("VU/8")(We, je, !1, function (e) {
								i("Vx6P")
							}, "data-v-04c9bb9d", null).exports,
						Ve = {
							data: function () {
								return {
									AppStatus: a.a
						...
						var _e = i("VU/8")(Ve, qe, !1, function (e) {
								i("zV2A")
							}, "data-v-71a6d528", null).exports,
						ze = i("SWtL"),
						Qe = function (e) {
